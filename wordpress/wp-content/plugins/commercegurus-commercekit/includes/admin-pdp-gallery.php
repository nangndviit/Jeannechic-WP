...
<div id="settings-content" class="postbox content-box">
	...
	<p><?php esc_html_e( 'To report any issues or if there is a specific extension you would like us to make compatible with CommerceKit Product Gallery', 'commercegurus-commercekit' ); ?> <a href="?page=commercekit&tab=support"><?php esc_html_e( 'let us know', 'commercegurus-commercekit' ); ?></a>. <?php esc_html_e( 'Read our blog post to', 'commercegurus-commercekit' ); ?> <a href="https://www.commercegurus.com/woocommerce-product-gallery-speed/"><?php esc_html_e( 'learn more', 'commercegurus-commercekit' ); ?></a> <?php esc_html_e( 'about the CommerceKit Product Gallery.', 'commercegurus-commercekit' ); ?></p>
		...
		<table class="form-table product-gallery" role="presentation">
			...
			<tr> <th scope="row"><?php esc_html_e( 'Minimal mobile layout', 'commercegurus-commercekit' ); ?></th> <td> <label for="commercekit_pdp_mobile_optimized" class="toggle-switch"> <input name="commercekit[pdp_mobile_optimized]" type="checkbox" id="commercekit_pdp_mobile_optimized" value="1" <?php echo isset( $commercekit_options['pdp_mobile_optimized'] ) && 1 === (int) $commercekit_options['pdp_mobile_optimized'] ? 'checked="checked"' : ''; ?>><span class="toggle-slider"></span></label><label>&nbsp;&nbsp;<?php esc_html_e( 'Removes thumbnails and arrows and makes the gallery edge-to-edge.', 'commercegurus-commercekit' ); ?></label></td> </tr>
			<tr> <th scope="row"><?php esc_html_e( 'Enable thumbnail arrows?', 'commercegurus-commercekit' ); ?></th> <td> <label for="commercekit_pdp_thumb_arrows" class="toggle-switch"> <input name="commercekit[pdp_thumb_arrows]" type="checkbox" id="commercekit_pdp_thumb_arrows" value="1" <?php echo isset( $commercekit_options['pdp_thumb_arrows'] ) && 1 === (int) $commercekit_options['pdp_thumb_arrows'] ? 'checked="checked"' : ''; ?>><span class="toggle-slider"></span></label><label>&nbsp;&nbsp;<?php esc_html_e( 'Enable gallery thumbnail previous / next arrows.', 'commercegurus-commercekit' ); ?></label></td> </tr>
