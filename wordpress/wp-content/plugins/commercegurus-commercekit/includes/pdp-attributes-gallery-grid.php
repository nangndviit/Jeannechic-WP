...
$layout_template = '<div class="swiper-container cg-main-swiper"><ul class="swiper-wrapper cg-psp-gallery" itemscope itemtype="http://schema.org/ImageGallery">{gallery-images}</ul><div class="swiper-button-next"></div><div class="swiper-button-prev"></div><div class="load-more-images more" data-more="' . esc_html__( 'Load more images', 'commercegurus-commercekit' ) . '" data-less="' . esc_html__( 'Show less images', 'commercegurus-commercekit' ) . '">' . esc_html__( 'Load more images', 'commercegurus-commercekit' ) . '</div></div><div thumbsSlider="" class="swiper-container cg-thumb-swiper cg-thumbs-' . esc_attr( $pdp_attributes_thumbs ) . ' cg-thumbs-count-{img-count}"><ul class="swiper-wrapper" itemscope itemtype="http://schema.org/ImageGallery">{gallery-thumbs}</ul>' . ( isset( $options['pdp_thumb_arrows'] ) && 1 === (int) $options['pdp_thumb_arrows'] ? '<div class="swiper-button-next swiper-button-disabled"></div><div class="swiper-button-prev swiper-button-disabled"></div>' : '' ) . '</div>';
?>
