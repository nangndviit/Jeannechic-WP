...
class Client {
	...
	public function is_local_server() {
		$is_local = isset( $_SERVER['REMOTE_ADDR'] ) && in_array( $_SERVER['REMOTE_ADDR'], array( '127.0.0.1', '::1' ) );

		return apply_filters( 'appsero_is_local', $is_local );
	}

	/**
	 * Translate function esc_html_e()
	 */
