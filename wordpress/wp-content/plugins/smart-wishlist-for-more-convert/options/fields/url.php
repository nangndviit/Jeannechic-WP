<?php
/**
 * Template for displaying the Url Field
 *
 * @author MoreConvert
...
<input class="regular-text <?php echo esc_attr( $class ); ?>" id="<?php echo esc_attr( $field_id ); ?>" autocomplete="off" name="<?php echo esc_attr( $name ); ?>" type="url" value="<?php echo esc_attr( $value ); ?>"
