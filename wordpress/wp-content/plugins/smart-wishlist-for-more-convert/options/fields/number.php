...
?>
<input type="number" autocomplete="off" id="<?php echo esc_attr( $field_id ); ?>" name="<?php echo esc_attr( $name ); ?>" class="regular-text <?php echo esc_attr( $class ); ?>" value="<?php echo esc_attr( $value ); ?>"
