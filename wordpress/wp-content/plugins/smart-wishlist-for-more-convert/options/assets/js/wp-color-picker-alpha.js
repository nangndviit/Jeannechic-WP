  ...
  $.widget('a8c.iris', $.a8c.iris, {
    ...
    _create: function _create() {
      try {
        ...
        this.alphaOptions = this.element.wpColorPicker('instance').alphaOptions; // Remove square href attribute because scroll to top of body on click it.

        this.document.find('.iris-square-value').removeAttr('href');
    ...
    _setOption: function _setOption(key, value) {
      ...
      if ('color' === key && self.alphaOptions.alphaEnabled) {
        ...
        value = '' + value;
        var newColor = new Color(value).setHSpace(self.options.mode); // Check if error && Check the color to prevent callbacks with the same color.
