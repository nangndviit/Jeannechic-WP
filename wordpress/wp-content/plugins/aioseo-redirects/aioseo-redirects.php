...
new AIOSEOExtend( 'AIOSEO - Redirects', 'aioseo_redirects_load', AIOSEO_REDIRECTION_MANAGER_FILE, '4.5.8' );
...
function aioseo_redirects_load() {
	...
	$extend = new AIOSEOExtend( 'AIOSEO - Redirects', '', AIOSEO_REDIRECTION_MANAGER_FILE, '4.5.8', $levels );
