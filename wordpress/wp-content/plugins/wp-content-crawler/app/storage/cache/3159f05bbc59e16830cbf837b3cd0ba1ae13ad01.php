...
<table class="wcc-settings">
    ...
    <?php echo $__env->make('partials.table-section-title', [
        'title' => _wpcc("Media"),
        'key'   => \WPCCrawler\Objects\Enums\SectionKey::GENERAL_SETTINGS_POST_MEDIA,
    ], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <?php if($isGeneralPage): ?>
        ...
        <?php echo $__env->make('partials.table-section-title', [
            ...
            'key'   => \WPCCrawler\Objects\Enums\SectionKey::GENERAL_SETTINGS_POST_SHORT_CODES,
        ], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php /**PATH /www/wwwroot/jeannechic.com/wp-content/plugins/wp-content-crawler/app/views/general-settings/tab-post.blade.php ENDPATH**/ ?>