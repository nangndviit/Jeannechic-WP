...
<table class="wcc-settings">
    ...
    <?php echo $__env->make('form-items.combined.template-editor-with-label', [
        ...
        'title'     => _wpcc('Post Content Template'),
        'info'      => _wpcc('The template used for the content of the posts. The buttons above the editor hold short
            ...
            copying, just place the short codes into anywhere you want in the editor.'),
        'buttons'   => $buttonsMain
    ...
    <?php echo $__env->make('partials.table-section-title', [
        'title' => _wpcc("Item Templates"),
        'key'   => \WPCCrawler\Objects\Enums\SectionKey::SITE_SETTINGS_TEMPLATES_ITEM_TEMPLATES,
    ], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <?php echo $__env->make('partials.table-section-title', [
        'title' => _wpcc("Quick Fixes"),
        'key'   => \WPCCrawler\Objects\Enums\SectionKey::SITE_SETTINGS_TEMPLATES_QUICK_FIXES,
    ], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <?php echo $__env->make('form-items.combined.checkbox-with-label', [
        ...
        'title' =>  _wpcc('Remove links?'),
        'info'  =>  sprintf(_wpcc('If you want to remove the links from all of the short code data, check this.
    ...
    <?php echo $__env->make('partials.table-section-title', [
        ...
        'key'   => \WPCCrawler\Objects\Enums\SectionKey::SITE_SETTINGS_TEMPLATES_UNNECESSARY_ELEMENTS,
    ], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <?php echo $__env->make('partials.table-section-title', [
        ...
        'key'   => \WPCCrawler\Objects\Enums\SectionKey::SITE_SETTINGS_TEMPLATES_MANIPULATE_HTML,
    ], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php /**PATH /www/wwwroot/jeannechic.com/wp-content/plugins/wp-content-crawler/app/views/site-settings/tab-templates.blade.php ENDPATH**/ ?>