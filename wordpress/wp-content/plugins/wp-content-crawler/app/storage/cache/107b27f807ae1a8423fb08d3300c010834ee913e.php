...
<table class="wcc-settings">
    ...
    <?php echo $__env->make('partials.table-section-title', [
        'title' => _wpcc("Customizations"),
        'key'   => \WPCCrawler\Objects\Enums\SectionKey::SITE_SETTINGS_MAIN_CUSTOMIZATIONS,
    ], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <?php echo $__env->make('partials.table-section-title', [
        'title' => _wpcc("Request"),
        'key'   => \WPCCrawler\Objects\Enums\SectionKey::SITE_SETTINGS_MAIN_REQUEST,
    ], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

    
    <?php echo $__env->make('form-items.combined.multiple-cookie-with-label', [
    ...
    <?php echo $__env->make('partials.table-section-title', [
        'title' => _wpcc("Settings Page"),
        'key'   => \WPCCrawler\Objects\Enums\SectionKey::SITE_SETTINGS_MAIN_SETTINGS_PAGE
    ], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php /**PATH /www/wwwroot/jeannechic.com/wp-content/plugins/wp-content-crawler/app/views/site-settings/tab-main.blade.php ENDPATH**/ ?>