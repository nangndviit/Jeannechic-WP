...
<table class="wcc-settings">
    ...
    <?php echo $__env->make('partials.table-section-title', [
        ...
        'key'   => \WPCCrawler\Objects\Enums\SectionKey::SITE_SETTINGS_POST_CATEGORY,
    ], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <?php echo $__env->make('partials.table-section-title', [
        'title' => _wpcc("Date"),
        'key'   => \WPCCrawler\Objects\Enums\SectionKey::SITE_SETTINGS_POST_DATE,
    ], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <?php echo $__env->make('partials.table-section-title', [
       'title' => _wpcc("Meta"),
       'key'   => \WPCCrawler\Objects\Enums\SectionKey::SITE_SETTINGS_POST_META,
   ], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <?php echo $__env->make('partials.table-section-title', [
        'title' => _wpcc("Featured Image"),
        'key'   => \WPCCrawler\Objects\Enums\SectionKey::SITE_SETTINGS_POST_FEATURED_IMAGE,
    ], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <?php echo $__env->make('partials.table-section-title', [
        'title' => _wpcc("Custom Short Codes"),
        'key'   => \WPCCrawler\Objects\Enums\SectionKey::SITE_SETTINGS_POST_CUSTOM_SHORT_CODES,
    ], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <tr>
        <td>
            <?php echo $__env->make('form-items/label', [
                ...
                'title' =>  _wpcc('Custom Short Code Selectors'),
                'info'  =>  _wpcc('CSS selectors for HTML elements whose contents can be used in the post template
                    ...
                    can use it <b>in the post content template by writing [item-price]</b>')
            ], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </td>
        <td>
    ...
    <?php echo $__env->make('partials.table-section-title', [
                'title' => _wpcc("List Type Posts"),
                'key'   => \WPCCrawler\Objects\Enums\SectionKey::SITE_SETTINGS_POST_LIST_TYPE_POSTS,
            ], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <?php echo $__env->make('partials.table-section-title', [
        'title' => _wpcc("Pagination"),
        'key'   => \WPCCrawler\Objects\Enums\SectionKey::SITE_SETTINGS_POST_PAGINATION,
    ], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <?php echo $__env->make('form-items.combined.multiple-selector-with-attribute', [
        ...
        'title'         =>  _wpcc('Next Page URL Selectors'),
    ...
    <?php echo $__env->make('form-items.combined.multiple-selector-with-attribute', [
        ...
        'title'         =>  _wpcc('All Page URLs Selectors'),
    ...
    <?php echo $__env->make('partials.table-section-title', [
        'title' => _wpcc("Post Meta"),
        'key'   => \WPCCrawler\Objects\Enums\SectionKey::SITE_SETTINGS_POST_POST_META,
    ], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <?php echo $__env->make('partials.table-section-title', [
                'title' => _wpcc("Taxonomies"),
                'key'   => \WPCCrawler\Objects\Enums\SectionKey::SITE_SETTINGS_POST_TAXONOMIES,
            ], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <?php echo $__env->make('partials.table-section-title', [
        'title' => _wpcc("Unnecessary Elements"),
        'key'   => \WPCCrawler\Objects\Enums\SectionKey::SITE_SETTINGS_POST_UNNECESSARY_ELEMENTS,
    ], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <?php echo $__env->make('partials.table-section-title', [
        'title' => _wpcc("Filters"),
        'key'   => \WPCCrawler\Objects\Enums\SectionKey::SITE_SETTINGS_POST_FILTERS,
    ], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <?php echo $__env->make('partials.table-section-title', [
        'title' => _wpcc("Other"),
        'key'   => \WPCCrawler\Objects\Enums\SectionKey::SITE_SETTINGS_POST_OTHER,
    ], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php /**PATH /www/wwwroot/jeannechic.com/wp-content/plugins/wp-content-crawler/app/views/site-settings/tab-post.blade.php ENDPATH**/ ?>