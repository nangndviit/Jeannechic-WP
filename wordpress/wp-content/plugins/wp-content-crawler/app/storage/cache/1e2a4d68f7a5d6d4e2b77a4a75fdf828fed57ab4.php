...
>
    ...
    <td>
        <?php echo $__env->make('form-items/multiple', [
            'include'       => 'form-items/exchange-attrs',
            'name'          => $name,
            'addKeys'       => true,
        ], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php echo $__env->make('partials/test-result-container', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </td>
</tr><?php /**PATH /www/wwwroot/jeannechic.com/wp-content/plugins/wp-content-crawler/app/views/form-items/combined/multiple-exchange-attrs-with-label.blade.php ENDPATH**/ ?>