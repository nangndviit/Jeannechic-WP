...
<ul data-results="<?php echo e(json_encode($results)); ?>" data-extra="<?php echo e(json_encode($extra ?? '')); ?>">
    <?php
...
<?php echo $__env->make('partials.info-list', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /www/wwwroot/jeannechic.com/wp-content/plugins/wp-content-crawler/app/views/partials/test-result.blade.php ENDPATH**/ ?>