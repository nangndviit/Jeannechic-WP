...
<?php if($isGeneralPage): ?>
    <h2 class="nav-tab-wrapper">
        ...
        <a href="#" data-tab="#tab-gs-apis" class="nav-tab"><?php echo e(_wpcc('APIs')); ?></a>
...
<div id="tab-gs-apis" class="tab<?php echo e($isGeneralPage ? '' : '-inside'); ?> <?php echo e($isGeneralPage ? 'hidden' : ''); ?>">
    <?php echo $__env->make('general-settings.tab-apis', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
</div>
...
<?php /**PATH /www/wwwroot/jeannechic.com/wp-content/plugins/wp-content-crawler/app/views/general-settings/settings.blade.php ENDPATH**/ ?>