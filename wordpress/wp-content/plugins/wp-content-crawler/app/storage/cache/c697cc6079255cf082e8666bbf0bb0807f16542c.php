            ...
            <div class="input-group site">
                ...
                <select name="site_id" id="site_id">
                    <?php $__currentLoopData = $sites; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $site): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($site->ID); ?>" data-order="<?php echo e($loop->index); ?>"
...
</div><?php /**PATH /www/wwwroot/jeannechic.com/wp-content/plugins/wp-content-crawler/app/views/site-tester/main.blade.php ENDPATH**/ ?>