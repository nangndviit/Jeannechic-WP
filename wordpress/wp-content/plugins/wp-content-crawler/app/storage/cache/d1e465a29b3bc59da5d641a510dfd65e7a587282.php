...
<table class="wcc-settings">
    ...
    <?php echo $__env->make('partials.table-section-title', [
        'title' => _wpcc("Recrawling"),
        'key'   => \WPCCrawler\Objects\Enums\SectionKey::GENERAL_SETTINGS_SCHEDULING_RECRAWLING,
    ], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <?php echo $__env->make('partials.table-section-title', [
        'title' => _wpcc("Deleting"),
        'key'   => \WPCCrawler\Objects\Enums\SectionKey::GENERAL_SETTINGS_SCHEDULING_DELETING,
    ], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php /**PATH /www/wwwroot/jeannechic.com/wp-content/plugins/wp-content-crawler/app/views/general-settings/tab-scheduling.blade.php ENDPATH**/ ?>