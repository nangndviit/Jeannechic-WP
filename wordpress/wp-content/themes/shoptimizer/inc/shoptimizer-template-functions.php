		...
		if ( 'enable' === $shoptimizer_mobile_myaccount ) {
			?>
				<div class="mobile-myaccount">
					<a href="<?php echo get_permalink( get_option('woocommerce_myaccount_page_id') ); ?>" title="<?php esc_attr_e( 'My Account', 'shoptimizer' ); ?>">
...
if ( ! function_exists( 'shoptimizer_site_title_or_logo' ) ) {
	...
	$shoptimizer_tagline_display = shoptimizer_get_option( 'shoptimizer_tagline_display' );
		...
		if ( function_exists( 'the_custom_logo' ) && has_custom_logo() ) {
			...
			$html = '<' . esc_attr( $tag ) . ' class="site-title"><a href="' . esc_url( home_url( '/' ) ) . '" rel="home" class="custom-logo-link">' . esc_html( get_bloginfo( 'name' ) ) . '</a></' . esc_attr( $tag ) . '>';
...
if ( ! function_exists( 'shoptimizer_primary_navigation' ) ) {
	...
	?>
			...
			<nav id="site-navigation" class="main-navigation" aria-label="<?php esc_attr_e( 'Primary Navigation', 'shoptimizer' ); ?>">
...
if ( ! function_exists( 'shoptimizer_skip_links' ) ) {
	...
	function shoptimizer_skip_links() {
		?>
		<a class="skip-link screen-reader-text" href="#site-navigation"><?php esc_html_e( 'Skip to navigation', 'shoptimizer' ); ?></a>
		<a class="skip-link screen-reader-text" href="#content"><?php esc_html_e( 'Skip to content', 'shoptimizer' ); ?></a>
		<?php
	}
}
	...
	$shoptimizer_layout_blog_prev_next = shoptimizer_get_option( 'shoptimizer_layout_blog_prev_next' );
		...
		<aside class="entry-meta">
			...
			<div class="post-meta">
				...
				<div class="cat-links">
						<?php
						echo '<div class="label">' . esc_html( __( 'Posted in:', 'shoptimizer' ) ) . '</div>';
				...
				<div class="tags-links">
						<?php
						echo '<div class="label">' . esc_html( __( 'Tagged:', 'shoptimizer' ) ) . '</div>';
...
if ( ! function_exists( 'shoptimizer_mobile_menu_close' ) ) {
	...
	function shoptimizer_mobile_menu_close() {
		echo '<div class="mobile-menu close-drawer">
