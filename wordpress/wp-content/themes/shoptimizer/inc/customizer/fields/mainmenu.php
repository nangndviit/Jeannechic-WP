...
// Display recently added in search modal.
shoptimizer_Kirki::add_field(
	'shoptimizer_config', array(
		'type'      => 'toggle',
		'settings'  => 'shoptimizer_layout_search_recent',
		'label'     => esc_html__( 'Show recent products in modal', 'shoptimizer' ),
		'section'   => 'shoptimizer_header_section_layout',
		'default'   => $shoptimizer_default_options['shoptimizer_layout_search_recent'],
		'priority'  => 10,
		'transport' => 'auto',
		'active_callback'  => [
			[
...
shoptimizer_Kirki::add_field(
	'shoptimizer_config', array(
		...
		'output'    => array(
			array(
				'element'  => '.site-header-cart a.cart-contents .shoptimizer-cart-icon .mini-count',
				'property' => 'background-color',
			),
		),
		'transport' => 'postMessage',
...
shoptimizer_Kirki::add_field(
	'shoptimizer_config', array(
		...
		'label'     => esc_html__( 'Cart sidebar - hide view cart link', 'shoptimizer' ),
		'section'   => 'shoptimizer_cart_section_layout',
		'default'   => 0,
		'priority'  => 10,
		'transport' => 'refresh',
...
shoptimizer_Kirki::add_field(
	'shoptimizer_config', array(
		...
		'label'     => esc_html__( 'Cart sidebar quantity', 'shoptimizer' ),
		'section'   => 'shoptimizer_cart_section_layout',
		'default'   => 0,
		'priority'  => 10,
		'transport' => 'refresh',
...
shoptimizer_Kirki::add_field(
	...
	array(
		...
		'output'   => array(
			array(
				'element'  => '.site .header-widget-region p, .site .header-widget-region li',
				'property' => 'font-size',
			),
		),
	)
