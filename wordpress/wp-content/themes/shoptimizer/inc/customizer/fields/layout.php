...
shoptimizer_Kirki::add_field(
	'shoptimizer_config', array(
		...
		'output'      => array(
			array(
				'element'  => '.col-full, .single-product .site-content .shoptimizer-sticky-add-to-cart .col-full, body .woocommerce-message, .single-product .site-content .commercekit-sticky-add-to-cart .col-full',
				'property' => 'max-width',
				'units'    => 'px',
			),
			array(
...
shoptimizer_Kirki::add_field(
	'shoptimizer_config', array(
		...
		'choices'  => array(
			...
			'aioseo'  => esc_attr__( 'AIOSEO Breadcrumbs', 'shoptimizer' ),
...
/*shoptimizer_Kirki::add_field(
	'shoptimizer_config', array(
		'type'      => 'toggle',
		'settings'  => 'shoptimizer_layout_woocommerce_category_description_padding',
		'label'     => esc_html__( 'Category description padding', 'shoptimizer' ),
		'section'   => 'shoptimizer_layout_section_woocommerce',
		'default'   => 1,
		'priority'  => 10,
		'transport' => 'refresh',
		'active_callback'  => array(
			...
			array(
				'setting'  => 'shoptimizer_layout_woocommerce_category_description',
				'value'    => true,
				'operator' => '==',
			),
			array(
				'setting'  => 'shoptimizer_layout_woocommerce_category_image',
				'value'    => false,
				'operator' => '==',
			),
		),
...
shoptimizer_Kirki::add_field(
	'shoptimizer_config', array(
		...
		'label'       	=> esc_attr__( 'Mobile cart page', 'shoptimizer' ),
